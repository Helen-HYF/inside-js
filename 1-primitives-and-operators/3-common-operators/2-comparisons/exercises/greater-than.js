...
const _1_expect = true > 'a'; // __
const _1_native = '1' > 1;
console.assert(_1_expect === _1_native, 'Test 1');

const _2_expect = false > null; // __
